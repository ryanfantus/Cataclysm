...
t_door_c, t_door_b, t_door_o, t_door_locked, t_door_locked_alarm, t_door_frame,
 t_door_boarded, t_door_b_boarded, t_door_locked_boarded, t_door_frame_boarded,
t_door_metal_c, t_door_metal_o, t_door_metal_locked,
t_door_glass_c, t_door_glass_o,
t_bulletin,
t_portcullis,
t_window, t_window_alarm, t_window_empty, t_window_frame,
 t_window_boarded, t_window_empty_boarded, t_window_frame_boarded,
t_rock, t_fault,
t_paper,
// Tree
...
{"boarded up door",  '#', c_brown,   0, tr_null,
	mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(supports_roof)},
{"boarded up damaged door", '#', c_brown, 0, tr_null,
	mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(supports_roof)},
{"boarded up door",  '#', c_brown,   0, tr_null,	// Locked
	mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(supports_roof)},
{"boarded up door frame",  '=', c_brown,   0, tr_null,
	mfb(transparent)|mfb(bashable)|mfb(flammable)|mfb(noitem)|
        mfb(supports_roof)},
...
{"boarded up window",'#', c_brown,   0, tr_null,
	mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(supports_roof)},
{"boarded up empty window",'#', c_brown,   0, tr_null,
	mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(supports_roof)},
{"boarded up window frame",'#', c_brown,   0, tr_null,
	mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(supports_roof)},
